...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/angler2.png') }}" width="150" height="91" alt="ロゴ">
                </a>
    ...
    <footer>
        <ul class="footer_menu">
            <a href=""><li class="icon_1">|　　Anglerとは？　|</li></a>
            <a href=""><li class="icon_2">|　　漁港登録　　|</li></a>
            <a href=""><li class="icon_3">|　　お問い合わせ　　|</li></a>
        </ul>
        <p class="footer_mess">SNSで最新情報発信中！！</p>
        <ul class="footer_menu">
            <li class="icon_1">
                <a href="">
        ...
        ©︎All rights reserved by Angler
    </footer>
</body>
</html>
